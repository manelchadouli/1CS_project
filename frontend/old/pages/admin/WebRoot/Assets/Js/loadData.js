...
//     var table = document.getElementById("table-validation-themes");
...
//     // Get the page
//     var page = document.querySelector(".themes-page");
...
//     window.popup.style.minHeight = fullHeight + "px";
...
//     // Set the title
//     form.children[0].innerHTML = window.data[index].titre;

//     // Set the full title
//     form.children[1].children[1].value = window.data[index].titreComplet;
